...
8. **Work calendar** (needed for fixed-duration initiatives) – `Admin → Work calendar`. Set *hours per working day* (default 8) and add company holidays (weekdays only; Saturdays/Sundays are never working days). Working days = Mon–Fri minus holidays.

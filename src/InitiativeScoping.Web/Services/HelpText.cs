...
public static class HelpText
{
    ...
    [
        ...
        new("eac", "Estimate at completion (EAC)", "Actual cost to date plus the estimate to complete. Excludes contingency; shown once a baseline exists and actuals have been recorded."),
        new("eac-budget", "Expected total vs. budget", "EAC (actual cost to date + estimate to complete) plus the contingency reserve captured on the baseline. This is the figure compared against the approved budget once actuals exist."),
        ...
        new("remaining", "Remaining", "Approved budget minus the expected total (EAC + baseline contingency reserve once actuals exist, otherwise forecast incl. contingency). Negative means over budget; within 10% shows Near budget."),
